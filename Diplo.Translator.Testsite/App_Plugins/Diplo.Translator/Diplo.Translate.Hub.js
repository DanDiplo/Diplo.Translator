(function () {
    ...
    function diploTranslatorHub($rootScope, $q, assetsService) {
        ...
        function hubSetup(callback) {
            ...
            $.connection = new signalR.HubConnectionBuilder()
                .withUrl(Umbraco.Sys.ServerVariables.diploTranslator.signalRHub)
                    ...
                    start: function (cb) {
                        ...
                        try {
                            $.connection.start().then(function () {
                                ...
                                console.warn('Failed to start diplo translate hub');
                                if (cb) {
                                    cb(false);
                                }
                            });
                        } catch (e) {
                            console.warn('Could not setup signalR connection for diplo translate hub', e);
                            if (cd) {
                                cb(false);
                            }
                        }
    ...
    angular.module('umbraco.resources')
        .factory('diploTranslatorHub', diploTranslatorHub);
})();